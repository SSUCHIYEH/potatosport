...
typealias ActionCalssifier = MyActionClassifier_1
...
class Predictor{
    ...
    func labelActionType(){
        guard let actionClassifier = try? ActionCalssifier(configuration: MLModelConfiguration()),
    ...
    func processObservation(_ observation:VNHumanBodyPoseObservation){
        do{
            //顯示關節陣列的第一個名稱
            print("關節名稱：\(observation.availableJointNames[0].rawValue.rawValue)")
            //print("關節名稱：\(observation.availableJointNames)")
